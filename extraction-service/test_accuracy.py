...
def main():
    ...
    try:
        ...
        print(f"[OK] Loaded: custom_transcript_ner_model")
    except:
        print("[ERROR] Could not load custom_transcript_ner_model")
    ...
    print("[OK] Results saved to test_accuracy_results.json")
    print()
