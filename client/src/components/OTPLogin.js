...
const OTPLogin = ({ onSuccess, onError }) => {
  ...
  return (
    ...
    >
      ...
      <h1
        style={{
        background: "linear-gradient(90deg, #ffffff 0%, #d4e9ff 100%)",
...
>       Welcome to the <span style={{ color: "#fff" }}>Student OTP Login</span>
      </h1>
      ...
      >
       ...
       {/* */} {/* Header */}
        <div style={{ textAlign: "center", marginBottom: "2rem" }}>
          ...
          >
            {step === "email" ? "Scholarship Recommender" : "Verify Your Email"}
          </h2>
          <p
            style={{
              fontSize: "0.95rem",
