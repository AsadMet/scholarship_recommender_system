...
If "Preferred Discipline" section not found AND text says "open to all courses" or "applicable to all programmes/programs", return: ["All Fields"]
...
function postProcessCourses(courses) {
  ...
  const ctaPatterns = /(apply now|frequently asked questions|faq|dont miss out|do not miss out|click here|read more|learn more|find out more|contact us)/i;
  ...
  const cleaned = expanded
    ...
    // Remove CTA or navigation-like phrases that are not courses
    .filter(c => !ctaPatterns.test(c))
